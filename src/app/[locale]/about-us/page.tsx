...
export default function About() {
  ...
  return (
    <S.AboutWrapper>
      <S.VideoWrapper>
        <S.Video
          src={getImageUrl(data?.banner?.data.attributes.url)}
          muted
          loop
        />
      </S.VideoWrapper>
      <MainLayout>
        ...
        <MainLayout>
          <S.WhoWeAre>
            <S.WhoWeAreImage src={getImageUrl(data?.whoWeAre.image.data.attributes.url)}/>
            <S.WhoWeAreContent>
              <S.WhoWeAreTitle>{data?.whoWeAre.title}</S.WhoWeAreTitle>
              <S.WhoWeAreDescription dangerouslySetInnerHTML={{ __html: data?.whoWeAre.content || '' }} />
            </S.WhoWeAreContent>
          </S.WhoWeAre>
        <S.InfoBlock>
