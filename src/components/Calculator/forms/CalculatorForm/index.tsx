...
import { useCreateCalculatorMutation } from '@/features/calculator/calculator.api';
// import { FormState } from '@/components/FormState';
// import { Modal as FormStateModal } from '@nextui-org/react';
...
function CalculatorForm() {
  ...
  const [createCalculator] = useCreateCalculatorMutation();
  ...
  const onSubmit: SubmitHandler<CalculatorFormValues> = async (data) => {
    try {
      await createCalculator(data).unwrap();
      // setIsError(false);
    } catch (error: any) {
      // setIsError(true);
    } finally {
    ...
    <div>
      ...
      <S.CalculatorForm onSubmit={handleSubmit(onSubmit)}>
        ...
        <Button
          ...
          type="submit"
          disabled={isFormStateOpen || isButtonDisabled}
        >
          {isFormStateOpen
