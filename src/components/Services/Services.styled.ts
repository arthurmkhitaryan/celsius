...
export const ServiceItem = styled.div<{ serviceSingleShow?: boolean, isExpanded?: boolean }>`
    display: flex;
...
export const ImageWrapper = styled.div<{ serviceSingleShow?: boolean, isExpanded?: boolean, imageUrl?: string }>`
    opacity: ${({ serviceSingleShow, isExpanded }) => serviceSingleShow && isExpanded ? 1 : 0.5};
